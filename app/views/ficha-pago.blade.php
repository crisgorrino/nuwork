...
<section class="container cf pdd">
		<section class="inner">
		<div class="solicitar"><span>Gracias tu pedido a sido procesado</span></div>
        ...
        <tr>
            ...
            <br>
            <p>Una vez realizado el dep&oacute;sito o la transferencia bancaria, deber&aacute;s cargar el comprobante ya sea escaneado o impresi&oacute;n de pantalla en nuestro sistema ingresando al Login de cliente ubicado en la parte inferior de nuestra p&aacute;gina, &oacute; bien haciendo <a href="comprobante-pago.php" class="turq" target="_blank">click aqu&iacute;</a>, con los siguientes datos de usuario:</p>
                <br>
            <p><strong>Usuario:</strong>   ra@hot.com</p>
            <p><strong>Contrase&ntilde;a:</strong>   E4BD83AA-9AF6-832C-6EC7-231BFD6382AE</p>
                <br>
