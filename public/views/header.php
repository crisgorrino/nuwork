<header>
	<section class="inner">
		<a class="left logo" href="index.php"><img src="img/logo.png"  alt="NuWork - Coworking Space"></a>
		...
		<nav class="main-menu">
			<ul class="left">
				...
				<li><a class="" href="login.php">Pagos</a></li>
				<li><a class="" href="comprobante-pago.php">Carga tu comprobante</a></li>
			</ul>
			<a href="https://www.facebook.com/nuworkgdl"><span class="icon-facebook"></span></a>
			<a href="https://twitter.com/nuworkgdl"><span class="icon-twitter"></span></a>
